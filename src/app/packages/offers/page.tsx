...
export default function Page() {
  return (
    <>
      <PageHeroSection
        title="Offers"
        subtitle="Detailed information about Offers at SVKM's Krutiben Bhupeshbhai Patel Ayurveda Hospital."
        breadcrumb={[{ label: "Packages", href: "/packages" }, { label: "Offers", href: "/packages/offers" }]}
      />
