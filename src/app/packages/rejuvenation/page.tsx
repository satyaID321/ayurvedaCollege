...
export default function Page() {
  return (
    <>
      <PageHeroSection
        title="Rejuvenation"
        subtitle="Detailed information about Rejuvenation at SVKM's Krutiben Bhupeshbhai Patel Ayurveda Hospital."
        breadcrumb={[{ label: "Packages", href: "/packages" }, { label: "Rejuvenation", href: "/packages/rejuvenation" }]}
      />
