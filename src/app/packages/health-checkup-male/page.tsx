...
export default function Page() {
  return (
    <>
      <PageHeroSection
        title="Health Checkup Male"
        subtitle="Detailed information about Health Checkup Male at SVKM's Krutiben Bhupeshbhai Patel Ayurveda Hospital."
        breadcrumb={[{ label: "Packages", href: "/packages" }, { label: "Health Checkup Male", href: "/packages/health-checkup-male" }]}
      />
