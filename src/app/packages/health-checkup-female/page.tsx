...
export default function Page() {
  return (
    <>
      <PageHeroSection
        title="Health Checkup Female"
        subtitle="Detailed information about Health Checkup Female at SVKM's Krutiben Bhupeshbhai Patel Ayurveda Hospital."
        breadcrumb={[{ label: "Packages", href: "/packages" }, { label: "Health Checkup Female", href: "/packages/health-checkup-female" }]}
      />
