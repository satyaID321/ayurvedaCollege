...
export default function Page() {
  return (
    <>
      <PageHeroSection
        title="Cart"
        subtitle="Detailed information about Cart at SVKM's Krutiben Bhupeshbhai Patel Ayurveda Hospital."
        breadcrumb={[{ label: "Shop", href: "/shop" }, { label: "Cart", href: "/shop/cart" }]}
      />
