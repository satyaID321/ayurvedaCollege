  ...
  return (
    <>
      <PageHeroSection
        ...
        subtitle="Detailed information about Health Products at SVKM's Krutiben Bhupeshbhai Patel Ayurveda Hospital."
        breadcrumb={[{ label: "Shop", href: "/shop" }, { label: "Health Products", href: "/shop/health-products" }]}
      />
