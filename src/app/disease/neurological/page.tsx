...
export default function Page() {
  return (
    <>
      <PageHeroSection
        title="Neurological"
        subtitle="Detailed information about Neurological at SVKM's Krutiben Bhupeshbhai Patel Ayurveda Hospital."
        breadcrumb={[{ label: "Disease", href: "/disease" }, { label: "Neurological", href: "/disease/neurological" }]}
      />
