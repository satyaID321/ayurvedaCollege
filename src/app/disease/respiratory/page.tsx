...
export default function Page() {
  return (
    <>
      <PageHeroSection
        title="Respiratory"
        subtitle="Detailed information about Respiratory at SVKM's Krutiben Bhupeshbhai Patel Ayurveda Hospital."
        breadcrumb={[{ label: "Disease", href: "/disease" }, { label: "Respiratory", href: "/disease/respiratory" }]}
      />
