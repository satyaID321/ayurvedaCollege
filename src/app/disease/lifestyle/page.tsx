...
export default function Page() {
  return (
    <>
      <PageHeroSection
        title="Lifestyle"
        subtitle="Detailed information about Lifestyle at SVKM's Krutiben Bhupeshbhai Patel Ayurveda Hospital."
        breadcrumb={[{ label: "Disease", href: "/disease" }, { label: "Lifestyle", href: "/disease/lifestyle" }]}
      />
