...
export default function Page() {
  return (
    <>
      <PageHeroSection
        title="Skin"
        subtitle="Detailed information about Skin at SVKM's Krutiben Bhupeshbhai Patel Ayurveda Hospital."
        breadcrumb={[{ label: "Disease", href: "/disease" }, { label: "Skin", href: "/disease/skin" }]}
      />
