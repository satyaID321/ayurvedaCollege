...
export default function Page() {
  return (
    <>
      <PageHeroSection
        title="Womens Health"
        subtitle="Detailed information about Womens Health at SVKM's Krutiben Bhupeshbhai Patel Ayurveda Hospital."
        breadcrumb={[{ label: "Disease", href: "/disease" }, { label: "Womens Health", href: "/disease/womens-health" }]}
      />
