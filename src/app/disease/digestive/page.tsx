...
export default function Page() {
  return (
    <>
      <PageHeroSection
        title="Digestive"
        subtitle="Detailed information about Digestive at SVKM's Krutiben Bhupeshbhai Patel Ayurveda Hospital."
        breadcrumb={[{ label: "Disease", href: "/disease" }, { label: "Digestive", href: "/disease/digestive" }]}
      />
