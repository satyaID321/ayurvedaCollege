...
export default function Page() {
  return (
    <>
      <PageHeroSection
        title="Arthritis"
        subtitle="Detailed information about Arthritis at SVKM's Krutiben Bhupeshbhai Patel Ayurveda Hospital."
        breadcrumb={[{ label: "Disease", href: "/disease" }, { label: "Arthritis", href: "/disease/arthritis" }]}
      />
