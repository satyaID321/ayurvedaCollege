...
export default function Page() {
  return (
    <>
      <PageHeroSection
        title="Surgery"
        subtitle="Detailed information about Surgery at SVKM's Krutiben Bhupeshbhai Patel Ayurveda Hospital."
        breadcrumb={[{ label: "Treatments", href: "/treatments" }, { label: "Surgery", href: "/treatments/surgery" }]}
      />
