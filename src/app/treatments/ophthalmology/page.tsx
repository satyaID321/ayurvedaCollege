...
export default function Page() {
  return (
    <>
      <PageHeroSection
        title="Ophthalmology"
        subtitle="Detailed information about Ophthalmology at SVKM's Krutiben Bhupeshbhai Patel Ayurveda Hospital."
        breadcrumb={[{ label: "Treatments", href: "/treatments" }, { label: "Ophthalmology", href: "/treatments/ophthalmology" }]}
      />
