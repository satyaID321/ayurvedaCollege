...
export default function Page() {
  return (
    <>
      <PageHeroSection
        title="Gynaecology"
        subtitle="Detailed information about Gynaecology at SVKM's Krutiben Bhupeshbhai Patel Ayurveda Hospital."
        breadcrumb={[{ label: "Treatments", href: "/treatments" }, { label: "Gynaecology", href: "/treatments/gynaecology" }]}
      />
