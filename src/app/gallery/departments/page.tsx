...
export default function Page() {
  return (
    <>
      <PageHeroSection
        title="Departments"
        subtitle="Detailed information about Departments at SVKM's Krutiben Bhupeshbhai Patel Ayurveda Hospital."
        breadcrumb={[{ label: "Gallery", href: "/gallery" }, { label: "Departments", href: "/gallery/departments" }]}
      />
