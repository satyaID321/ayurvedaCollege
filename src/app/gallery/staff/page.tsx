...
export default function Page() {
  return (
    <>
      <PageHeroSection
        title="Staff"
        subtitle="Detailed information about Staff at SVKM's Krutiben Bhupeshbhai Patel Ayurveda Hospital."
        breadcrumb={[{ label: "Gallery", href: "/gallery" }, { label: "Staff", href: "/gallery/staff" }]}
      />
