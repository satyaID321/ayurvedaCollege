...
export default function Page() {
  return (
    <>
      <PageHeroSection
        title="Cme"
        subtitle="Detailed information about Cme at SVKM's Krutiben Bhupeshbhai Patel Ayurveda Hospital."
        breadcrumb={[{ label: "Events", href: "/events" }, { label: "Cme", href: "/events/cme" }]}
      />
