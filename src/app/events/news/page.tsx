...
export default function Page() {
  return (
    <>
      <PageHeroSection
        title="News"
        subtitle="Detailed information about News at SVKM's Krutiben Bhupeshbhai Patel Ayurveda Hospital."
        breadcrumb={[{ label: "Events", href: "/events" }, { label: "News", href: "/events/news" }]}
      />
