...
export default function Page() {
  return (
    <>
      <PageHeroSection
        title="Camps"
        subtitle="Detailed information about Camps at SVKM's Krutiben Bhupeshbhai Patel Ayurveda Hospital."
        breadcrumb={[{ label: "Events", href: "/events" }, { label: "Camps", href: "/events/camps" }]}
      />
