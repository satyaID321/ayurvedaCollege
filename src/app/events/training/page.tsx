...
export default function Page() {
  return (
    <>
      <PageHeroSection
        title="Training"
        subtitle="Detailed information about Training at SVKM's Krutiben Bhupeshbhai Patel Ayurveda Hospital."
        breadcrumb={[{ label: "Events", href: "/events" }, { label: "Training", href: "/events/training" }]}
      />
