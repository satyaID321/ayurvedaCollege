...
export default function Page() {
  return (
    <>
      <PageHeroSection
        title="Podcasts"
        subtitle="Detailed information about Podcasts at SVKM's Krutiben Bhupeshbhai Patel Ayurveda Hospital."
        breadcrumb={[{ label: "Wellness", href: "/wellness" }, { label: "Podcasts", href: "/wellness/podcasts" }]}
      />
