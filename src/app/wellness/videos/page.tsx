...
export default function Page() {
  return (
    <>
      <PageHeroSection
        title="Videos"
        subtitle="Detailed information about Videos at SVKM's Krutiben Bhupeshbhai Patel Ayurveda Hospital."
        breadcrumb={[{ label: "Wellness", href: "/wellness" }, { label: "Videos", href: "/wellness/videos" }]}
      />
