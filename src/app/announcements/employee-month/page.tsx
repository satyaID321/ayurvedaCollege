  ...
  return (
    <>
      <PageHeroSection
        ...
        subtitle="Detailed information about Employee Month at SVKM's Krutiben Bhupeshbhai Patel Ayurveda Hospital."
        breadcrumb={[{ label: "Announcements", href: "/announcements" }, { label: "Employee Month", href: "/announcements/employee-month" }]}
      />
