  ...
  return (
    <>
      <PageHeroSection
        ...
        subtitle="Detailed information about Accreditations at SVKM's Krutiben Bhupeshbhai Patel Ayurveda Hospital."
        breadcrumb={[{ label: "Achievements", href: "/achievements" }, { label: "Accreditations", href: "/achievements/accreditations" }]}
      />
